...
void TreeModel::addItem(TreeItem *curItem, TreeItem *parent)
{
    parent->setChild(curItem, parent);
}
...
/*void TreeModel::setupModelData(const QStringList &lines, TreeItem *parent)
{
    ...
    while (number < lines.count())
    {
        ...
        if(!lineData.isEmpty())
        {
            ...
            {
                //The last child of the current parent is now the new oarent
            ...
            //Append a new item to the current parent's list children.
